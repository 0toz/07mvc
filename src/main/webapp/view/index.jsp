...
<script type="text/javascript">
	function test01() {
		location.href="/07_MVC/MyController?cmd=hello";
	}
	function test02() {
		location.href="/07_MVC/MyController?cmd=hi";
	}
	function test03() {
		location.href="/07_MVC/MyController?cmd=bye";
	}
	
	function test04(f){
		f.action="/07_MVC/MyController?cmd=hello";
		f.submit;
	}
	function test05(f){
		f.action="/07_MVC/MyController?cmd=hi";
		f.submit;
	}
	function test06(f){
		f.action="/07_MVC/MyController?cmd=bye";
		f.submit;
	}
</script>
</head>
<body>
	...
	<form action="/07_MVC/MyController" method="post">
	...
	<div>
   <h2> 성적 입력 </h2>
   <form action="gradeResult" method="post">
      <table>
         <tbody>
